...
//Variable que contiene todo los datos de las mercancias existentes
//esta variable se llena cuando llamamos la funcion listMer() 3 
 var clientes = [];
 /**
* Muestra el contenido de las mercancias almacenadas en la BD
* Toma TODAS las mercancias con estatus 1
*/
function listCliente()
{
	...
	{	
	//En caso de	que el servicio nos devuelva una exception esta semanda a imprimir en una alerta
	...
	contenido +=	"<tr>";
	contenido +=	"<td colspan='15' class='text-center'>";
	contenido +=	"<img alt='' src='imagenes/saDog.png'style='height: 256px;' /><br>";
        contenido +=	"<span class=' font-weight-bold'>¡Por elmomento, no tienes clientes en tu lista!<span>";
	contenido +=	"</td>";
	contenido +=	"<tr>";
	...
	{	
            //Para no dejar vacía la tabla se comoca una imagen y un mensaje de que no hay información
            contenido +=	"<tr>";
            contenido +=	"<td colspan='15' class='text-center'>";
            contenido +=	"<img alt='' src='imagenes/saDog.png'style='height: 256px;' /><br>";
            contenido +=	"<span class='text-danger font-weight-bold'>Por elmomento, no tienes clientes en tu catálogo.<span>";
            contenido +=	"</td>";
            contenido +=	"<tr>";
            $("#tBodyClientes").html(contenido);
            return;	
        ...
        {	
            ...
            for (var i =0; i < clientes.length; i++)
            {
                ...
                contenido += "<tr>";
                contenido += "<td> <button onclick='modifyCli(" + i + ")'class='btn btn-warning'>Modificar</button></td>";
                contenido += "<td> <button onclick='deleteCli(" + i + ")'class='btn btn-danger mx-4'>Eliminar</button></td>";
                contenido += "<td>" + clientes[i].persona.nombre + "</td>";
                contenido += "<td>" + clientes[i].persona.apellidoPaterno +"</td>";	
                contenido += "<td>" + clientes[i].persona.apellidoMaterno +"</td>";
                contenido += "<td>" + clientes[i].persona.fechaNacimiento +"</td>";
                contenido += "<td>" + clientes[i].persona.calle +"</td>"; 
                contenido += "<td>" + clientes[i].persona.numero +"</td>";
                contenido += "<td>" + clientes[i].persona.colonia+"</td>";
                contenido += "<td>" + clientes[i].persona.cp +"</td>";
                contenido += "<td>" + clientes[i].persona.ciudad +"</td>";
                contenido += "<td>" + clientes[i].persona.estado +"</td>";
                contenido += "<td>" + clientes[i].persona.tel1 +"</td>";
                contenido += "<td>" + clientes[i].persona.tel2+"</td>";
                contenido += "<td>" + clientes[i].correo +"</td>";
                contenido += "<td>" + clientes[i].contrasenia +"</td>";
                contenido += "</tr>";	
            }
...
function listCliInactive()
{
    var contenido = "";
    $.ajax({
	type: "GET",
	url: "rest/cliente/getAllInactive",
	async: true
	}).done(
	function (data)	
	{	
            ...
            contenido +=	"<tr>";
            contenido +=	"<td colspan='15' class='text-center'>";
            contenido +=	"<img alt='' src='imagenes/surpriseDog.png'style='height: 256px;' /><br>";
            contenido +=	"<span class='text-danger font-weight-bold'>Por elmomento, no tienes clientes inactivos.<span>";
            contenido +=	"</td>";
            contenido +=	"<tr>";
            $("#tBodyClientes").html(contenido);
            return;	
            ...
            //Para no dejar vacía la tabla se comoca una imagen y un mensaje de	que o hay información
            contenido +=	"<tr>";
            contenido +=	"<td colspan='20' class='text-center'>";
            contenido +=	"<img alt='' src='imagenes/surpriseDog.png'style='height: 256px;' /><br>";
            contenido +=	"<span class='text-danger font-weight-bold'>¡Por elmomento, no tienes clientes inactivos!.<span>";
            contenido +=	"</td>";
            contenido +=	"<tr>";
	...
	for (var i =0; i < clientes.length; i++)
        ...
        //se arma cada uno de los renglones de la tabla con cada registro
                ...
                contenido +="<tr>";
                contenido += "<td> <button onclick='reactivate(" + i + ")'class='btn btn-outline-success'>Reactivar</button></td>";
                contenido += "<td>" + clientes[i].persona.nombre + "</td>";
                contenido += "<td>" + clientes[i].persona.apellidoPaterno +"</td>";	
                contenido += "<td>" + clientes[i].persona.apellidoMaterno +"</td>";
                contenido += "<td>" + clientes[i].persona.fechaNacimiento +"</td>";
...
/*
* Esta función toma la posición de la mercancía que se quiere modificar y coloca
* los valores del registro dentro de los campos de tipo formulario
* para permitir la modificación de estos
* @param {int} i contiene el indice de persona que se quiere afectar (la posición del registro)

*/
function modifyCli(i)
{
        var objC = clientes[i];
	$("#txtIdCliente").val(objC.idCliente);
        $("#txtIdPersona").val(objC.persona.idPersona);
	$("#txtNombre").val(objC.persona.nombre);
	$("#txtAp1").val(objC.persona.apellidoPaterno);
	$("#txtAp2").val(objC.persona.apellidoMaterno);
        $("#txtFechaN").val(objC.persona.fechaNacimiento);
        $("#txtCalle").val(objC.persona.calle);
        $("#txtNum").val(objC.persona.numero);
        $("#txtColonia").val(objC.persona.colonia);
        $("#txtCP").val(objC.persona.cp);
        $("#txtCiudad").val(objC.persona.ciudad);
        $("#txtEstado").val(objC.persona.estado);
        $("#txtTel1").val(objC.persona.tel1);
        $("#txtTel2").val(objC.persona.tel2);
        $("#txtCorreo").val(objC.correo);
        $("#txtContra").val(objC.contrasenia);
}

/*	* Esta función toma la posición del registro en clientess para
	* tomar su idPersona y poder eliminarlo invocando al servicio para ello
	* @param {int} i contiene el indice de clientes que se quiere eliminar
*/
function deleteCli(i)
{
	var id = clientes[i].persona.idPersona;
	...
	/*
146	* Esta función toma el idProducto del formulario para
147	* poder eliminarlo invocando al servicio para ello
148	* No recibe parametros por que se invoca cuando se tienen los datos en el formulario
149	*/
	function deleteCli2()
	{
	...
	if (data.exception != null)
	{
	Swal.fire("Error en la Reactivación",
	data.exception,
	"error");
	} else
	{
	Swal.fire("Reactivación exitosa",
	...
	/**
191	* Función que toma los valores del los inpust tipo formulario
 
192	* Para generar un json que se va al servicio que almacena la información
193	*/
	function saveCli()
	{
	...
	var apellidoPaterno = document.getElementById("txtAp1").value;
	var apellidoMaterno = document.getElementById("txtAp2").value;
	var fechaNacimiento = document.getElementById("txtFechaN").value;
        fechaNacimiento = fechaNacimiento.toString();
        var dia = fechaNacimiento.substr(8,2);
        var mes = fechaNacimiento.substr(5,2);
        var year = fechaNacimiento.substr(0,4);
	...
	{
	Swal.fire("Cliente almacenado existosamente",
	"Inserción",
	"success");
	...
	/*
	* Función que limpia los campos de insertar/modificar cliente
	*/
	function cleanFieldsCli()
	{
            $("#txtIdPersona").val("");
            $("#txtIdCliente").val("");
            $("#txtNombre").val("");
...
function search()
{
	...
	$.ajax
	...
	}).done(function (data)
        {
           if (data.exception != null)
           {
                Swal.fire("La busqueda no se pudo procesar",
                data.exception,
                "error");
	    }
            else
            {
                Swal.fire("Cliente encontrado existosamente",
                "EXITO",
                "success");                     
